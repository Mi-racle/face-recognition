...
from static_pack.model import MiniFASNetV1, MiniFASNetV2, MiniFASNetV1SE, MiniFASNetV2SE
from static_pack.utils import parse_model_name, get_kernel, to_tensor
...
class AntiSpoofer(Detection):
    def __init__(self, device_id):
        super(AntiSpoofer, self).__init__()
    ...
    def predict(self, img, model_path):
        ...
        with torch.no_grad():
            ...
            result = softmax(result).cpu().numpy()
